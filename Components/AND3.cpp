...
void AND3::updateMatrix(GraphicsInfo GInfo, int ID, string type) ///team 13    //zbt alid wltype hebaaaa
{
...
void AND3::delete_from_Matrix(GraphicsInfo GInfo)
{
